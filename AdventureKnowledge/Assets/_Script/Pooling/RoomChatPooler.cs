...
public class RoomChatPooler : MonoBehaviour
{
    #region private Serialize Fields
    [SerializeField] private GameObject RoomChat;
    ...
    public static RoomChatPooler Instance { get; private set; }
    #endregion
    ...
    public GameObject GetPooledChat()
    {
        ...
        GameObject child = Instantiate(RoomChat, RoomChat.transform.position, Quaternion.identity);
